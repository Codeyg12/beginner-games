...
function displayStatusText(context) {
    ...
    if (gameOver) {
        ...
        context.fillStyle = 'black';
        context.fillText('GAME OVER! To play again press enter or swipedown', canvas.width/2, 200)
        context.fillStyle = 'white';
        context.fillText('GAME OVER! To play again press enter or swipedown', canvas.width/2 + 2, 198)
    }
}
