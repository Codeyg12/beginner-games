...
export class Running extends State {
    ...
    handleInput(input) {
        this.game.particles.unshift(new Dust(this.game, this.game.player.x + this.game.player.width * 0.3, this.game.player.y + this.game.player.height * 0.9));
...
//     handleInput(input) {
//         if (this.game.player.onGround()) {
//             this.game.player.setState(states., 1);
//         }
//     }
// }
